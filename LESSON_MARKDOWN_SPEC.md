...
يُحقَن داخل `{{PODCAST_INSTRUCTIONS}}` في القالب.]
...
<div class="voice-recorder-block" data-vr-id="vr1" data-word="works">
 ...
 <button class="vr-record-before"> تسجيل قبل</button>
 <audio class="vr-audio-before" controls hidden></audio>
 <button class="vr-record-after"> تسجيل بعد</button>
 ...
 **خطأ شائع للعرب:** نسيان الـ s مع 3rd person.
:::
...
<div class="callout callout-warning">
 <p> <strong>خطأ شائع للعرب:</strong> نسيان الـ s مع 3rd person.</p>
</div>
````
